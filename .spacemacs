...
values."
  (setq-default
   ...
   ;; Proor `spacemacs'. (default 'spacemacs)
   dotspacemacs-distribution 'spacemacs
   ;; Lazy installationPro of layers (i.e. layers are installed only when a file
   ;; with a supported type is opened). Possible values are `all', `unused'
   ;; and `nil'. `unused' will lazProy install only unused layers (i.e. layers
   ;; not listed in variable `dotspacemacs-configuration-laProyers'), `all' will
   ;; lazy install any layer that support lazy installation even the layers
   ;; listed in `dotspacemacs-configuration-layers'. `nil' disable the lazy
   ;; installation feature and you have to explicitly list a layer in the
   ;; variable `dotspacemacs-configuration-layers' to install it.
   ;; (default 'unused)
   dotspacemacs-enable-lazyPro-installation 'unused
   ...
   ;; unused packages as well as their unused dProependencies.
...
values."
  ...
  (setq-default
   ...
   dotspacemacs-default-font '("Source Han Sans HW SC"
                               :size 12
                               :weight normal
                               :width normal
                               :powerline-scale 1.0)
...
you should place your code here."
  ...
  (spacemacs//set-monospaced-font "Source Han Sans HW SC" "Source Han Sans HW SC" 12 12)

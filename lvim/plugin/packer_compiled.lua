...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'diffview.nvim', 'gitsigns.nvim', 'hop.nvim', 'indent-blankline.nvim', 'lsp-colors.nvim', 'nvim-colorizer.lua', 'nvim-comment', 'nvim-spectre'}, { event = "BufRead *" }, _G.packer_plugins)]]
